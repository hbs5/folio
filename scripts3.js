$(window).on('load', function () {
	...
	function funcaoNotificacao() {
		$.notify(nomes[Math.floor(Math.random() * nomes.length)] + " adquiriu o Plano <br></br>" + planos[Math.floor(Math.random() * planos.length)] + " há " + Math.floor(Math.random() * (60 - 1) + 1) + " minutos atrás", {
